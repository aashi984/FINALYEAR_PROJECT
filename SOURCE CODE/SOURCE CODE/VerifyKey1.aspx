<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/User.master" CodeFile="VerifyKey1.aspx.cs" Inherits="VerifyKey1" %>
...
.error-message {
   ...
   <asp:Panel ID="Panel1" runat="server" CssClass="form-container">
    <div class="verify-form">
        <h2 class="form-heading">Enter Key to Add Patient Data</h2>
