<%@ Page Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="PatientRegister.aspx.cs" Inherits="PatientRegister" Title="Untitled Page" %>
                        ...
                        <table style="width: 100%; height: 397px;">
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <td style="width: 199px">
                                    <asp:TextBox ID="TextBox7" runat="server" CssClass="txtstyle" Height="95px" TextMode="MultiLine "
                                        Width="164px"></asp:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td style="width: 19px">
                                    &nbsp;</td>
                                <td style="width: 199px">
                                    <asp:Button ID="Button1" runat="server" CssClass="submit2" Text="Register" 
